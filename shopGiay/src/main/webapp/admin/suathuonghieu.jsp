			...
			<div class="row">
				<div class="col-lg-8 mb-3 mb-lg-0">
					...
					<div class="card mb-3 mb-lg-5">
						...
						<div class="card-body">
							<!-- Form -->
							<c:set var="thbean" value="${requestScope.suath}" />
							<form method="post" action="AdminSuaTh"
								enctype="multipart/form-data" accept-charset="UTF-8">
								<div class="mb-4">
									<label class="form-label">Tên thương hiệu</label>
									<input type="text" class="form-control" name="tenth"
										placeholder="Nhập tên sản phẩm..." value="${thbean.tenThuongHieu}" required>
								</div>
								<!-- End Form -->
								<div class="mb-4">
									...
									<input type="text" class="form-control" name="oldanh" value="${thbean.anh}">
								</div>

								<div class="mb-4">
									<label class="form-label">Trạng thái</label>
									<select name="trangthai" style="width: 100px; height: 40px" ${thbean.trangThai}>
										<option value="true">Hiện</option>
										<option value="false">Ẩn</option>
									</select>
								</div>
								<button type="submit" name="them" class="btn btn-primary">Sửa
									Thương hiệu</button>
							</form>
						</div>
